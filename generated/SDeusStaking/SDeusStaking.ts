...
export class SDeusStaking__usersResult {
  value0: BigInt;
  value1: BigInt;
...
export class SDeusStaking extends ethereum.SmartContract {
  static bind(address: Address): SDeusStaking {
    return new SDeusStaking("SDeusStaking", address);
  }
  ...
  users(param0: Address): SDeusStaking__usersResult {
    let result = super.call("users", "users(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(param0)
    ]);

    return new SDeusStaking__usersResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_users(param0: Address): ethereum.CallResult<SDeusStaking__usersResult> {
    ...
    return ethereum.CallResult.fromValue(
      new SDeusStaking__usersResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
}
