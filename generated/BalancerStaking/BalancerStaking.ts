...
export class BalancerStaking__usersResult {
  value0: BigInt;
  value1: BigInt;
...
export class BalancerStaking extends ethereum.SmartContract {
  static bind(address: Address): BalancerStaking {
    return new BalancerStaking("BalancerStaking", address);
  }
  ...
  users(param0: Address): BalancerStaking__usersResult {
    let result = super.call("users", "users(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(param0)
    ]);

    return new BalancerStaking__usersResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_users(
    param0: Address
  ): ethereum.CallResult<BalancerStaking__usersResult> {
    ...
    return ethereum.CallResult.fromValue(
      new BalancerStaking__usersResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
}
