...
export class DeaDeusVault__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class DeaDeusVault__getReservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class DeaDeusVault extends ethereum.SmartContract {
  static bind(address: Address): DeaDeusVault {
    return new DeaDeusVault("DeaDeusVault", address);
  }
  ...
  burn(to: Address): DeaDeusVault__burnResult {
    let result = super.call("burn", "burn(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(to)
    ]);

    return new DeaDeusVault__burnResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_burn(to: Address): ethereum.CallResult<DeaDeusVault__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new DeaDeusVault__burnResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  getReserves(): DeaDeusVault__getReservesResult {
    let result = super.call(
      "getReserves",
    ...
    return new DeaDeusVault__getReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getReserves(): ethereum.CallResult<DeaDeusVault__getReservesResult> {
    let result = super.tryCall(
      "getReserves",
      "getReserves():(uint112,uint112,uint32)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new DeaDeusVault__getReservesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
